...
@WORKFLOWS.register_module("R3L_scienceworld_w_o_credit_workflow")
class R3LScienceWorldWoCreditWorkflow(Workflow):
    """
    R3L workflow for scienceworld without credit assignment (ablation study)
    ...
    def __init__(
        ...
        print(
            f"Initializing R3LScienceWorldWoCreditWorkflow (w/o credit assignment), temperature={self.temperature}"
        )
        self.reset(task)
    ...
    def run(self) -> List[Experience]:
        """Run the R3L scienceworld workflow and return experiences (without credit assignment)"""
            ...
            try:
                ...
                if not is_valid or is_perfect:
                    ...
                    try:
                        ...
                        print(f"[R3L w/o credit] Second rollout - reward: {second_reward}, steps: {second_steps}, improve: {second_reward > reward}")
