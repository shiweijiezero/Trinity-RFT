...
@WORKFLOWS.register_module("reflect_grpo_alfworld_workflow")
class ReflectGRPOAlfworldWorkflow(Workflow):
    """
    Reflect GRPO Workflow for Alfworld environment.
    ...
    def __init__(
        ...
        self.data_dir = f"reflect_grpo_alfworld_data"
        ...
        print(f"Initializing ReflectGRPOAlfworldWorkflow, temperature={self.temperature}")
        self.reset(task)
